...
| <a name="input_public_subnet_1a"></a> [public\_subnet\_1a](#input\_public\_subnet\_1a) | ID da Subnet Pública na Zona de Disponibilidade 1a | `string` | n/a | yes |
| <a name="input_public_subnet_1b"></a> [public\_subnet\_1b](#input\_public\_subnet\_1b) | ID da Subnet Pública na Zona de Disponibilidade 1b | `string` | n/a | yes |
